...
python inference.py --exp_name 240909_2line_from_285HM --checkepoch 305 --num_workers 12 --infer_path "/mnt/hdd1/sgh/MixNet/MixNet/infer_test_datas/2line" --num_points 100 --test_size 2048 2048 --net FSNet_H_M --mid True
